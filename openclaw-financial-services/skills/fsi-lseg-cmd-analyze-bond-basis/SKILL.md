---
name: fsi-lseg-cmd-analyze-bond-basis
description: |
  Analyze the bond futures basis with CTD identification, implied repo rate, and basis trade assessment — usage: /analyze-bond-basis <bond future RIC e.g. FGBLc1>
user-invocable: true
metadata: {}
---
